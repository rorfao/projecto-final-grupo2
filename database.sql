...
("Olaria Periquito", "Olaria", "Portalegre", "Nisa", "R. Prof. João Porto 21, 6050-344 NISA Espírito Santo, Nisa, Portalegre", 927531183, NULL, "https://www.facebook.com/people/Olaria-Pedrada-Ilda-Maria/100093673087721/", "Esta arte tradicional alentejana destaca-se pelas suas peças em barro, decoradas a partir da aplicação manual de pequenas pedras de quartzo branco. O seu fundador, o Mestre António Pequito, foi um dos mais emblemáticos e antigos oleiros da região", "/assets/db-olaria-periquito.jpg"),
